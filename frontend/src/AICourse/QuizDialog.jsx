...
const QuizDialog = ({ open, onClose, course }) => {
    ...
    return (
        <Dialog open={open} onOpenChange={onClose}>
            <DialogContent className="max-w-2xl" style={{ borderColor: `var(--borderColor)`, backgroundColor: `var(--background-color)` }}>
                <DialogHeader>
                    <DialogTitle>Quiz for {course.courseName}</DialogTitle>
                    <DialogDescription>
                        Answer the following questions carefully. Select only one option per question.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-5 max-h-[60vh] overflow-y-auto">
                    {loading ? (
                        ...
                        questions.map((q) => (
                            <div key={q.id} className="p-4 border-2 border-dashed border-primary rounded-lg mr-4">
